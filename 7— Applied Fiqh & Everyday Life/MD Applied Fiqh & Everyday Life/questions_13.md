# Applied Fiqh & Social Ethics Assessment
## 20 Questions for 13-Year-Olds

This assessment evaluates your comprehension of Islamic legal philosophy, social manners, marketplace ethics, and the sacred pilgrimage rites. It emphasizes comparative legal rulings (*Fiqh*) and core theological principles (*‘Aqīdah*).
...
#### 2. Under the scale of the Five Legal Rulings (*Al-Aḥkām al-Khamsah*), what is the difference between an Obligatory (*Farḍ*) action and a Recommended (*Mandūb*) action?
*   a) Obligatory actions carry no sin for omission, whereas Recommended actions do.
*   b) Recommended actions are rewarded if performed and punished if omitted, whereas Obligatory actions are not punished.
*   c) Obligatory actions are rewarded if performed and punished if omitted, while Recommended actions are rewarded if performed but carry no sin or punishment if omitted.
*   d) Both carry the exact same rewards and punishments; they are synonyms.
...
*   b) The windpipe (*Ḥulqūm*), the gullet (*Marī’*), and the two jugular veins (*Wadajayn*)
*   c) Only the two jugular veins (*Wadajayn*)
...
*   b) They are *Ḥalāl* without any dislike
*   c) They are *Makrūh* (disliked)
*   d) They are only allowed for travelers

#### 8. How is the virtue of modesty (*Ḥayā’*) connected to Islamic Creed (*‘Aqīdah*)?
*   a) It is a social custom that has no relation to creed.
*   b) It stems directly from knowing that Allah is *Al-Raqīb* (The Watchful) and *Al-Baṣīr* (The All-Seeing), motivating us to act respectably.
*   c) It is based on the belief that human bodies are naturally evil.
*   d) It is only required to avoid legal fines in Islamic states.

#### 9. In the Maliki school, how is a man’s thigh classified in terms of *‘Awrah*?
*   a) It is *‘Awrah Mughallaẓah* (heavy awrah); exposing it in prayer immediately invalidates the Salah.
*   b) It is not considered part of the *‘Awrah* at all and can be fully exposed anywhere.
*   c) It is *‘Awrah Khafīfah* (light awrah); exposing it in public is disliked/prohibited, but exposing it does not invalidate prayer.
...
*   b) The walking group
*   c) The oldest person in either group, regardless of status
...
*   b) They reject it; the contract becomes binding (*Lāzim*) immediately upon verbal agreement (offer and acceptance), based on *‘Amal Ahl al-Madīnah*.
*   c) They allow it only for online transactions, not physical ones.
...
*   b) It is a recommended Sunnah that can be compensated with animal sacrifice if missed.
*   c) It is an essential Pillar (*Rukn*); without it, Hajj and Umrah are invalid and cannot be fixed with sacrifice.
*   d) It is only obligatory for local residents of Makkah.

#### 20. What is the Maliki ruling regarding throwing pebbles at the *Jamarāt*?
*   a) The pebble only needs to touch the pillar itself; where it lands does not matter.
*   b) The pebble must land within the designated basin surrounding the pillar to count; if it misses, another must be thrown.
*   c) Throwing pebbles is recommended and can be skipped if the crowd is too large.
*   d) You can throw all seven pebbles in one single throw.
